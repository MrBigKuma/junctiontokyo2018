...
import io.batteryteam.dropboxofthings.StoreItemFragment.OnListFragmentInteractionListener
import kotlinx.android.synthetic.main.fragment_store_item.view.*

class StoreItemRecyclerViewAdapter(var values: List<TerradaItem>, private val listener: OnListFragmentInteractionListener?) : RecyclerView.Adapter<StoreItemRecyclerViewAdapter.ViewHolder>() {
